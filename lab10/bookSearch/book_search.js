...
function showBooks_XML(ajax) {
	...
	for(var i =0; i<books.length; i++){
		...
		li.innerHTML = books[i].getElementsByTagName("title")[0].firstChild.nodeValue+", by "+books[i].getElementsByTagName("author")[0].firstChild.nodeValue+" ("+books[i].getElementsByTagName("year")[0].firstChild.nodeValue+")";
